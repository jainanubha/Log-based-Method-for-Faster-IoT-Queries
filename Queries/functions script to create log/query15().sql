-- Function: public.query15()

-- DROP FUNCTION public.query15();

CREATE OR REPLACE FUNCTION public.query15()
  RETURNS void AS
$BODY$DECLARE
	rec_row RECORD;
	rec_cursor CURSOR 
...
where
L1.obj = '<http://knoesis.wright.edu/ssw/LocatedNearRelNWSN2>'
...
and L3.obj = '<http://knoesis.wright.edu/ssw/ont/weather.owl#_AirTemperature>'
and L4.sub = L3.sub
...
and L6.obj < '"32.0"^^<http://www.w3.org/2001/XMLSchema#float>');

-- Function: public.query8()

-- DROP FUNCTION public.query8();

CREATE OR REPLACE FUNCTION public.query8()
  RETURNS void AS
$BODY$DECLARE
	rec_row RECORD;
	rec_cursor CURSOR 
...
where
L1.obj = '<http://knoesis.wright.edu/ssw/point_NCSW1>'
...
and L3.obj = '<http://knoesis.wright.edu/ssw/ont/weather.owl#_WindGust>'
and L4.sub = L3.sub

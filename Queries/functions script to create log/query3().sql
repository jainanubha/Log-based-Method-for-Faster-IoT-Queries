-- Function: public.query3()

-- DROP FUNCTION public.query3();

CREATE OR REPLACE FUNCTION public.query3()
  RETURNS void AS
$BODY$DECLARE
	rec_row RECORD;
	rec_cursor CURSOR 
	...
	where
	L1.obj = '<http://knoesis.wright.edu/ssw/point_MWQTG>'
